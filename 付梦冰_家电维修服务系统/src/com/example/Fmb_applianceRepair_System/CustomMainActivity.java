...
public class CustomMainActivity extends Activity implements OnClickListener{
...
//			break;
	...
	private void btn_order() {
		if(user.roleCode==2){
			startActivity(new Intent(CustomMainActivity.this, OrderCompanyActivity.class) );
		}
		else if(user.roleCode==3){
			startActivity(new Intent(CustomMainActivity.this, OrderActivity.class) );
		}
	}

	private void btn_account() {
		startActivity(new Intent(CustomMainActivity.this, AccountActivity.class) );
	}

	//查看用户个人信息
	private void btn_userdate() {
		Intent intent = new Intent(CustomMainActivity.this,UserDateActivity.class);
